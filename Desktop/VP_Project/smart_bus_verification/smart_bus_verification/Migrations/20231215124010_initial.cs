    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RollNo = table.Column<string>(type: "nvarchar(15)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_AspNetUsers_RollNo", x => x.RollNo);
     ...
     columns: table => new
     {
         ...
         Roll = table.Column<string>(type: "nvarchar(15)", nullable: false),
         ...
         Card_issued_Date = table.Column<DateTime>(type: "datetime2", nullable: false),
     ...
     constraints: table =>
     {
         ...
         // Foreign Key
         table.ForeignKey(
             name: "FK_Students_AspNetUsers_Roll",
             column: x => x.Roll,
             principalTable: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_Roll",
                table: "Students",
                column: "Roll",
                unique: true,
                filter: "[Roll] IS NOT NULL");
        }
